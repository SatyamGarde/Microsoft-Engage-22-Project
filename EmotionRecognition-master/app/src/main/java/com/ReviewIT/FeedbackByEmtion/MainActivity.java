...
import com.ReviewIT.FeedbackByEmtion.classifiers.TFLiteImageClassifier;
import com.ReviewIT.FeedbackByEmtion.utils.ImageUtils;
import com.ReviewIT.FeedbackByEmtion.utils.SortingHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        no_of_f = findViewById(R.id.no_of_face);
                                ...
                                new OnSuccessListener<List<FirebaseVisionFace>>() {
                                    ...
                                    public void onSuccess(List<FirebaseVisionFace> faces) {
                                        ...
                                        if (!faces.isEmpty()) {
                                            ...
                                            faceId--;
                                              no_of_f.setText("Number of faces " + Integer.toString(faceId));
